...
class Disease {
    ...
    private:
        PType<double> strain; // Strain ID, applied when researches find a strain
        PType<DISEASE_TYPE> type; // type id for disease (parasite, virus, ect)
        PType<double> cells; // if living contagion
