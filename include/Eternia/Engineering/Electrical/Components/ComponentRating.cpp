...
// get maximum Power
PowerValue* ComponentRating::maxPower(){return powerMax;}
// get component resistance
double ComponentRating::getImpedance(){return impedance;}
// return dead
bool ComponentRating::isDead(){return dead;}
// return why it died
CR_DEATHCAUSE ComponentRating::getDeathCause(){return deathCause;}