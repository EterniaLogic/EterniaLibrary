...
ChannelledServer::ChannelledServer(SocketServerType serverType, CharString addr, int port, short buffer, void (*handler)(ChannelledClient*, PacketChannel* channel)){
