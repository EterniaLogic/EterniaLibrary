...
// defines a special property of the vector space, usually to help declare a "Special" Vector Space.
...
// a vector space is basically a Matrix of the resultant of 2 vectors.
...
public:
	...
	void addVector(vector* v); // adds vector to rows.
