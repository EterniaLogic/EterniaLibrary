...
void testAbstractDB(){
    AbstractDBTable* table = new AbstractDBTable("test.dat", ADB_BASE_DYNAMIC, ADBT_NONE);
    
    // Create a few fields for the database
    ...
    table->flushTable(); // flush data to the data file
}
