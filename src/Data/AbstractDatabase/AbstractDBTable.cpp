...
void AbstractDBTable::readHeader(){
	...
	switch (headerbase){
		case ADB_BASE_2:                        cout << "2 (32 values)" << endl; break;
		case ADB_BASE_2_EXTENDED:               cout << "2e (64 values)" << endl; break;
		case ADB_BASE_2_WIDE:                   cout << "2w (2048 values)" << endl; break;
			
		case ADB_BASE_3:                        cout << "3 (48 values)" << endl; break;
		case ADB_BASE_3_EXTENDED:               cout << "3e (96 values)" << endl; break;
		case ADB_BASE_3_WIDE:                   cout << "3w (3078 values)" << endl; break;
			
		case ADB_BASE_5:                        cout << "5 (80 values)" << endl; break;
		case ADB_BASE_5_EXTENDED:               cout << "5e (160 values)" << endl; break;
		case ADB_BASE_5_WIDE:        cout << "5w (5120 values)" << endl; break;
			
		case ADB_BASE_7:                        cout << "7 (112 values)" << endl; break;
		case ADB_BASE_7_EXTENDED:               cout << "7e (224 values)" << endl; break;
		case ADB_BASE_7_WIDE:        cout << "7w (7168 values)" << endl; break;
			
		case ADB_BASE_MAXV_1000:                cout << "mxv1000 (1000 values, inefficient)" << endl; break;
		case ADB_BASE_MAXV_10000:               cout << "mxv10000 (10000 values, inefficient)" << endl; break;
		case ADB_BASE_MAXV_100000:              cout << "mxv100000 (100000 values, mid-inefficient)" << endl; break;
		case ADB_BASE_MAXV_1000000:             cout << "mxv1000000 (1000000 values, mid-inefficient)" << endl; break;
		case ADB_BASE_MAXV_10000000:            cout << "mxv10000000 (10000000 values, inefficient)" << endl; break;
		case ADB_BASE_MAXV_100000000:           cout << "mxv100000000 (100000000 values, inefficient)" << endl; break;
		
		case ADB_BASE_DYNAMIC:           		cout << "dynamic (up to 2^32 or 2^64 values, unknown efficiency)" << endl; break;
	}
