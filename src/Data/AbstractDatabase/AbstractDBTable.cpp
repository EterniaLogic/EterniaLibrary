...
void AbstractDBTable::readHeader(){
	...
	switch (headerbase){
	case ADB_BASE_2: cout << "2 (32)" << endl; break;
	case ADB_BASE_2_EXTENDED: cout << "2e (64)" << endl; break;
	case ADB_BASE_2_WIDE: cout << "2w (2048)" << endl; break;
	case ADB_BASE_3: cout << "3" << endl; break;
	case ADB_BASE_3_EXTENDED: cout << "3e" << endl; break;
	case ADB_BASE_5: cout << "5" << endl; break;
	case ADB_BASE_5_EXTENDED: cout << "5e" << endl; break;
	case ADB_BASE_7: cout << "7" << endl; break;
	case ADB_BASE_7_EXTENDED: cout << "7e" << endl; break;
	}
