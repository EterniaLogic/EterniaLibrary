...
public:
    DryDistiller(){
        ...
        recipes.add(new Recipe("1kg wood","200mg charcoal, 20ml ethyl, 10ml tar, 10ml wood vinegar, 1ml formaldehyde, 100ml water\
18ml nitrogen, 2ml oxygen, 38ml co2, 23ml carbon monoxide, 17ml methane, 2ml hydrogen", 1200)); // gasses

        // coal coke making
        recipes.add(new Recipe("1kg coal","700mg coal coke, 1l ammonia, 500ml coal tar, 0.4ml coal gas", 1500);
    }
};
