#ifndef QUADRUPEDAL_H_
#define QUADRUPEDAL_H_

#include "IntelligentCreature.h"

class Quadrupedal : public IntelligentCreature{
    Quadrupedal(){
        classname="[Quadrupedal]";
        ...
        energy.foodtype = FOODT_CARNIVORE; // a lot of quadrupeds are carnivores
    }
